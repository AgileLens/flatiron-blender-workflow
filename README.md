...
The final candidate was visually compared against the imported baseline in matched 540 × 720 Cycles CPU renders (two threads, eight samples), both overview and detail. It gives modestly warmer, less uniform stone and deeper glazing; bright daylight still makes the facade pale. This is a portable material improvement candidate, not a verified leap to photorealism. M5 appearance and wearer acceptance remain unverified.
